function varargout = Irobot_GUI_gazebo2(varargin)
% IROBOT_GUI_GAZEBO2 MATLAB code for Irobot_GUI_gazebo2.fig
%      IROBOT_GUI_GAZEBO2, by itself, creates a new IROBOT_GUI_GAZEBO2 or raises the existing
%      singleton*.
%
%      H = IROBOT_GUI_GAZEBO2 returns the handle to a new IROBOT_GUI_GAZEBO2 or the handle to
%      the existing singleton*.
%
%      IROBOT_GUI_GAZEBO2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IROBOT_GUI_GAZEBO2.M with the given input arguments.
%
%      IROBOT_GUI_GAZEBO2('Property','Value',...) creates a new IROBOT_GUI_GAZEBO2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Irobot_GUI_gazebo2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Irobot_GUI_gazebo2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Irobot_GUI_gazebo2

% Last Modified by GUIDE v2.5 02-May-2015 12:40:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Irobot_GUI_gazebo2_OpeningFcn, ...
                   'gui_OutputFcn',  @Irobot_GUI_gazebo2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Irobot_GUI_gazebo2 is made visible.
function Irobot_GUI_gazebo2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Irobot_GUI_gazebo2 (see VARARGIN)

% Choose default command line output for Irobot_GUI_gazebo2
...
% UIWAIT makes Irobot_GUI_gazebo2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Irobot_GUI_gazebo2_OutputFcn(hObject, eventdata, handles) 
